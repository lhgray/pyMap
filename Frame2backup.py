...
[wxID_FRAME2, wxID_FRAME2BUTTON1, wxID_FRAME2BUTTON2, wxID_FRAME2BUTTON3, wxID_FRAME2BUTTON4, 
 ...
 wxID_FRAME2PANEL1, wxID_FRAME2STATUSBAR1, 
...
class Frame2(wx.Frame):
    ...
    def _init_coll_gridBagSizer1_Items(self, parent):
        ...
        parent.AddWindow(self.button4, (7, 0), border=5, flag=wx.ALIGN_TOP | wx.TOP | wx.LEFT,
              span=(1, 1))
        parent.AddWindow(self.panel1, (0, 1), border=5, flag=wx.GROW | wx.ALL, span=(8, 1))
    ...
    def _init_ctrls(self, prnt):
        # generated method, don't edit
        wx.Frame.__init__(self, id=wxID_FRAME2, name='', parent=prnt, pos=wx.Point(366, 235),
              size=wx.Size(852, 618),
              style=wx.MAXIMIZE | wx.DEFAULT_FRAME_STYLE | wx.RESIZE_BORDER,
              title='pyMap - A Flight Planning Utility')
        self._init_utils()
        self.SetClientSize(wx.Size(844, 584))
        ...
        self.panel1 = wx.Panel(id=wxID_FRAME2PANEL1, name='panel1', parent=self,
              pos=wx.Point(90, 5), size=wx.Size(749, 574),
        ...
        self.panel1.SetConstraints(LayoutAnchors(self.panel1, True, True, False, False))
